...
/**
 * Gradient noise generator using a shuffled permutation table with gradient vectors at integer lattice points with deterministic sampling.
 *
 ...
 */
public class GradientNoise implements NoiseSource {
    ...
    /** Creates a gradient noise instance with the given seed. */
