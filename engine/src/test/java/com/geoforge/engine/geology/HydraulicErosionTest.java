...
class HydraulicErosionTest {
    ...
    void erode_flatHeightmap_doesNotThrow() {
        ...
        assertDoesNotThrow(
                () -> HydraulicErosion.erode(heightmap, 16, 8, 0L),
    ...
    void erode_performance_completesUnder5ms() {
        ...
        assertTimeout(
                ...
                () -> HydraulicErosion.erode(heightmap, 16, 64, 0L),
    ...
    void erode_edgeCoordinates_noArrayIndexOutOfBounds() {
        ...
        assertDoesNotThrow(
                () -> HydraulicErosion.erode(heightmap, 16, 8, 42L),
    ...
    void erode_largerSize_doesNotThrow() {
        ...
        java.util.Arrays.fill(heightmap, 50.0f);
        assertDoesNotThrow(
                () -> HydraulicErosion.erode(heightmap, 48, 16, 99L),
    ...
    void erode_modifiesHeightmap() {
        ...
        HydraulicErosion.erode(heightmap, 16, 128, 77L);
    ...
    void erode_deterministic() {
        ...
        HydraulicErosion.erode(hm1, 16, 16, 123L);
        HydraulicErosion.erode(hm2, 16, 16, 123L);
