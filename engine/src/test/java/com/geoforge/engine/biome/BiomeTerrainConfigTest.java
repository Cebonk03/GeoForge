...
class BiomeTerrainConfigTest {
    ...
    void equality_differentValues() {
        var a = BiomeTerrainConfig.defaults();
        var b = new BiomeTerrainConfig(5.0, 1.0, 1.0, "", "", "", java.util.List.of(), false, 0.5, -1.0, 0, 0, 3);
        assertNotEquals(a, b);
    }
    ...
    void customConfig_accessors() {
        var cfg = new BiomeTerrainConfig(3.0, 0.8, 0.5, "oak", "grass_block", "dirt", java.util.List.of(), true, 0.3, -1.0, 2, 10, 5);
